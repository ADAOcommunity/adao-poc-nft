...
export default function Menu() {
    ...
    return (
        ...
        >
            <Navbar.Brand href="/">
                <Logo className="mt-4 ml-4 w-12 h-12 md:w-16 md:h-16" />
            </Navbar.Brand>
...
function ColorSwitch() {
    return (
        <button id="theme-toggle" type="button" onClick={ToggleColorSwitch} className="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
